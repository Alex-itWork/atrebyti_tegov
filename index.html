...
<!-- lorem генератор бесмысленного текста --->
lorem*80

<a href=""></a>

<p>
	Социальная инженерия — это способ получить доступ к информации или
    системам с помощью обмана и психологических манипуляций. Злоумышленники используют социальную инженерию, чтобы выведать конфиденциальную информацию: пароли, номера банковских счетов или личные данные.
</p>

<img src="https://www.shutterstock.com/ru/image-illustration/digital-ai-technology-concept-abstract-illustration-2540906635">

<p>
	В отличие от технических способов взлома, социальная инженерия нацелена на людей, а не на системы или сети. Преступники могут использовать поддельные электронные письма или сайты, придумывать истории, чтобы завоевать доверие жертвы и заставить ее раскрыть конфиденциальные сведения.hhacker
</p>
...
<!--  a anchor для поднятия вверх #вверх -->
<a href="https://dgem.io/">Подняться наверх</a>
